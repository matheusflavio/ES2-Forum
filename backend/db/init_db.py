...
cur.execute('INSERT INTO pauta (titulo,reuniao_id,usuario_id, documento,aprovado)'
            'VALUES (%s, %s, %s, %s, %s)',
            ("Gráfico de Contributors",3,1,"\\assets\\Contributions.png",True)
            )
cur.execute('INSERT INTO pauta (titulo,reuniao_id,usuario_id, documento,aprovado)'
            'VALUES (%s, %s, %s, %s, %s)',
            ("DCC Week", 3,1,"\\assets\\Documento.pdf",True)
            )
cur.execute('INSERT INTO pauta (titulo,reuniao_id,usuario_id, documento,aprovado)'
            'VALUES (%s, %s, %s, %s, %s)',
            ("Disciplina de Ciência de Dados",1,1,"\\assets\\Documento.pdf",True)
            )
cur.execute('INSERT INTO pauta (titulo,reuniao_id,usuario_id, documento,aprovado)'
            'VALUES (%s, %s, %s, %s, %s)',
            ("Mudança no percurso curricular de Ciência da Computação",2,1,"\\assets\\Documento.pdf",True)
            )
cur.execute('INSERT INTO pauta (titulo,reuniao_id,usuario_id, documento,aprovado)'
            'VALUES (%s, %s, %s, %s, %s)',
            ("Matriz curricular comum para CC e SI",3,1,"\\assets\\Documento.pdf",True)
            )
cur.execute('INSERT INTO pauta (titulo,reuniao_id,usuario_id, documento,aprovado)'
            'VALUES (%s, %s, %s, %s, %s)',
